...
type SharedInformerFactory interface {
	...
	Reststrategy() reststrategy.Interface
}

func (f *sharedInformerFactory) Reststrategy() reststrategy.Interface {
	return reststrategy.New(f, f.namespace, f.tweakListOptions)
}
